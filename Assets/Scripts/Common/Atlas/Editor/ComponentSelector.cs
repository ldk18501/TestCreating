...
public class ComponentSelector : ScriptableWizard
{
	...
	bool DrawObject (Object obj)
	{
		...
		GUILayout.BeginHorizontal();
		{
			...
			retVal |= GUILayout.Button(obj.name, GUIStyle.none, GUILayout.Width(160f), GUILayout.Height(20f));
			retVal |= GUILayout.Button(path.Replace("Assets/", ""), GUIStyle.none, GUILayout.Height(20f));
