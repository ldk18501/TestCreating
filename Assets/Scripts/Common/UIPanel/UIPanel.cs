...
public class UIPanel : MonoBehaviour, IOnPanelShow, IOnPanelHide
{
    ...
    private Coroutine _mShowSubElementCallCoroutine;
    private Coroutine _mHideSubElementCallCoroutine;
    ...
    public void ShowSubElements(string elementName, UnityAction callOnComplete = null)
    {
        ...
        if (callOnComplete != null)
        {
            ...
            if (doCallback)
            {
                ...
                _mShowSubElementCallCoroutine = UIPanelManager.Instance.CallWithDelay(() =>
                {
                    callOnComplete.Invoke();
                    _mShowSubElementCallCoroutine = null;
                }, finishTime);
            }
        }
    ...
    public void HideSubElements(string elementName, UnityAction callOnComplete = null)
    {
        ...
        if (callOnComplete != null)
        {
            ...
            if (doCallback)
            {
                _mHideSubElementCallCoroutine = UIPanelManager.Instance.CallWithDelay(() =>
                {
                    callOnComplete.Invoke();
                    _mHideSubElementCallCoroutine = null;
                }, finishTime);
            }
        }
    ...
    {
        if (_mShowSubElementCallCoroutine != null)
        {
            UIPanelManager.Instance.StopCoroutine(_mShowSubElementCallCoroutine);
            _mShowSubElementCallCoroutine = null;
            UIManager.HideUiElement(elementName);
        }

        if (_mHideSubElementCallCoroutine != null)
        {
            UIPanelManager.Instance.StopCoroutine(_mHideSubElementCallCoroutine);
            _mHideSubElementCallCoroutine = null;
            UIManager.ShowUiElement(elementName);
        }
    }
